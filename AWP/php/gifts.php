...
if (isset($_POST['submit'])) {
  ...
  $sql_insert = "INSERT INTO cart (user_id, product_id, name, price, image) SELECT id, '$product_id', '$product_name', '$product_price', '$product_img' FROM users WHERE username = '$username'";
...
<body>
  ...
  <h2 style="text-align: center; font-size: 70px; margin-top: 100px; color: white; ">Gifts</h2>
  ...
  <div class="container">
    <aside>
      ...
      <ul>
        ...
        <li><a href="#" class="category">Graduation</a></li>
        <li><a href="#" class="category">Birthday</a></li>
        <li><a href="#" class="category">Wedding</a></li>
      </ul>
    </aside>
