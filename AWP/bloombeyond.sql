...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 16, 2024 at 07:18 AM
...
INSERT INTO `cart` (`id`, `user_id`, `product_id`, `name`, `price`, `image`) VALUES
(9, 3, 15, 'Jewelry box', 88, 'https://i.pinimg.com/564x/8d/e0/fd/8de0fdc1bff25e23de4a039127d85fd4.jpg'),
(11, 3, 2, 'Bouquet Design', 29, 'https://i.pinimg.com/564x/35/2d/53/352d5319aeb667b44b3ace21ebc23b0b.jpg'),
(13, 3, 1, 'Strawberry Design', 22, 'https://i.pinimg.com/564x/9f/3a/c7/9f3ac785958d5d95ef88e2c613927c3e.jpg'),
(14, 3, 3, 'Birthday Design', 44, 'https://i.pinimg.com/564x/d0/01/7e/d0017efd8d792785cc0a320d8af8d623.jpg');
...
(1, 3, 2147483647, 65, 44, 666),
(2, 3, 2147483647, 5, 24, 333);
...
INSERT INTO `products` (`product_id`, `type`, `name`, `description`, `price`, `image`) VALUES
...
(1, 2, 'hello, I have a problem'),
(2, 2, 'hello, I have a problem');
...
(2, 'jno', 'jenanaljurishi2@gmail.com', '$2y$10$BFuJiqJjnWH69wNOmE9RqefkliQ7FKo6Ftf8Ltt7DvClcBC/KFUy.'),
(3, 'jenan', 'jenan@gmail.com', '$2y$10$Z9NhnVddcA1ycvhdfxHGNOhmRfJ1tJg.krxaJHeKm58xMCgkyOWhS');
